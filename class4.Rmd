...
for (i in 1:10) {
  ...
  predictions = predict(fit, trainset[ind == i, ! names(trainset) %in% c("churn")], type="class")
...
model =train(churn~., data=trainset, method="rpart", trControl=control,tuneGrid=tune_funs)
model
